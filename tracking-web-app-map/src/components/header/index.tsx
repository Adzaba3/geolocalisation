...
const Header: React.FC = () => {
  return (
    <header className="bg-white bg-opacity-50 backdrop-blur-lg backdrop-filter">
      <div className="container mx-auto flex flex-col items-center justify-between px-4 py-4 sm:flex-row sm:py-6">
        ...
        <h1 className="bg-gradient-to-r from-blue-400  font-bold  sm:text-3xl md:text-4xl">
          Map Tracker
        </h1>
        {/* <div className="mt-2 rounded-lg bg-gradient-to-r from-blue-400 to-purple-500 p-2 sm:mt-0"> */}
        <div className="mt-2 rounded-lg from-blue-400 to-purple-500 p-2 sm:mt-0">
          <LanguageSelector />
        </div>
      </div>
    </header>
